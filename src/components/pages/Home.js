        ...
        <div className="container mx-auto lg:aboslute lg:pt-5 group border-2 border-blue-400">
          <section className="lg:flex p-5 lg:pb-10 lg:justify-center m-20 md:m-5">
            <div className="text-4xl sm:text-6xl md:text-center lg:flex lg:flex-col lg:relative group lg:grid lg:grid-cols-4 xl:grid-cols-12">
              ...
              <h2 className="text-blue-400 mb-10 xl:col-span-4 lg:col-span-2 md:col-span-3">
              ...
              <h2 className="text-blue-400 mb-10 xl:col-span-3 lg:col-span-2">
                <span className="text-blue-400 lg:text-indigo-600 group-hover:text-blue-400 font-bold">
                  Creative
                </span>
                <br></br>
              ...
              <h2 className="text-blue-400 mb-10 xl:col-span-3 lg:col-span-2 md:col-span-3">
                <span className="text-blue-400 lg:text-indigo-600 group-hover:text-blue-400 font-bold">
                  Ambitious
                </span>
                <br></br>
